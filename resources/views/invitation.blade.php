            ...
            <div class="overflow-x-hidden w-full">
                ...
                <section
                    ...
                    <div class="relative text-center w-full max-w-4xl" data-aos="zoom-in">
                        ...
                        <h1 class="font-wedding text-yellow-400 text-6xl md:text-8xl mb-4">Aisyah & Fadil</h1>
                        <p class="text-lg md:text-2xl font-light mb-1 opacity-90">Minggu, 7 Juni 2026</p>
                        <p class="text-base md:text-lg font-light opacity-70">Pukul 11:00 - 13:00 WIB</p>
                ...
                <section class="py-24 bg-soft-maroon text-rose-100 relative z-10 overflow-hidden">
                    <div class="max-w-4xl mx-auto px-6 text-center" data-aos="fade-up">
                        ...
                        <p class="text-xl md:text-2xl font-serif italic mb-8 leading-relaxed">
                            ...
                            بَيْنَكُمْ مَّوَدَّةً وَّرَحْمَةًۗ اِنَّ فِيْ ذٰلِكَ لَاٰيٰتٍ لِّقَوْmٍ يَّتَفَكَّرُوْنَ
                        </p>
                        <p class="mb-6 text-base md:text-lg opacity-80 leading-relaxed px-4">
                            ...
                            sendiri, agar kamu merasa tenteram kepadanya, dan Dia menjadikan di antaramu rasa cinta dan kasih
                            sayang."
                        </p>
                        <h3 class="font-wedding text-3xl text-yellow-500 mb-10">Ar-Rum : 21</h3>
                    ...
                    <div class="max-w-4xl mx-auto px-6 text-center">
                        ...
                        <div class="space-y-8">
                            <div data-aos="fade-up">
                                ...
                                <p class="text-gray-600 italic mt-2">Putri kedua dari Almarhum Bapak Amir Budi Sulistijo<br>dan Ibu
                                    Choiriah Agung Padmi</p>
                            </div>

                            <h3 class="font-wedding text-4xl text-rose-800">dengan</h3>

                            <div data-aos="fade-up">
                                <h2 class="font-wedding text-5xl md:text-6xl text-rose-900">Ahmad Fadilah</h2>
                                <p class="text-gray-600 italic mt-2">Putra keempat dari Almarhum Bapak Solihin<br>dan Almarhumah Ibu
                                    Tunah</p>
                            </div>
                        </div>
                        ...
                        <div class="mt-20 space-y-10">
                            ...
                            <h2 class="font-wedding text-5xl md:text-6xl text-rose-900">Minggu, 7 Juni 2026</h2>
                    ...
                    <div class="max-w-5xl mx-auto px-6 text-center">
                        ...
                        <div class="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                            <div class="text-left space-y-6 px-2" data-aos="fade-right">
                                ...
                                <a href="https://maps.app.goo.gl/tmYvb1VPjdyMe64h7" target="_blank"
                    ...
                    <div class="max-w-md mx-auto px-6" data-aos="fade-up">
                        <div class="p-8 md:p-10 bg-white rounded-3xl shadow-2xl border border-rose-100">
                            ...
                            <div class="mt-8 pt-8 border-t border-gray-100">
                                {{-- <p class="text-xs text-gray-400 mb-4 uppercase tracking-widest"></p> --}}
                                @php
                    ...
                    if (el) {
                        el.innerHTML = `
                            <div class="bg-white/10 backdrop-blur-md p-2 md:p-3 rounded-xl border border-white/20 min-w-[60px] md:min-w-[75px]">
                                <span class="text-xl md:text-2xl font-bold block">${d}</span> <span class="text-[8px] md:text-[10px] uppercase">Hari</span>
                            </div>
                            <div class="bg-white/10 backdrop-blur-md p-2 md:p-3 rounded-xl border border-white/20 min-w-[60px] md:min-w-[75px]">
                                <span class="text-xl md:text-2xl font-bold block">${h}</span> <span class="text-[8px] md:text-[10px] uppercase">Jam</span>
                            </div>
                            <div class="bg-white/10 backdrop-blur-md p-2 md:p-3 rounded-xl border border-white/20 min-w-[60px] md:min-w-[75px]">
                                <span class="text-xl md:text-2xl font-bold block">${m}</span> <span class="text-[8px] md:text-[10px] uppercase">Menit</span>
                            </div>
                            <div class="bg-white/10 backdrop-blur-md p-2 md:p-3 rounded-xl border border-white/20 min-w-[60px] md:min-w-[75px]">
                                <span class="text-xl md:text-2xl font-bold block">${s}</span> <span class="text-[8px] md:text-[10px] uppercase">Detik</span>
                            </div>
                        `;
                    }
                }, 1000);
